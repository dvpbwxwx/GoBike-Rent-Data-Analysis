...
df = pd.read_csv("https://raw.githubusercontent.com/dvpbwxwx/GoBike-Rent-Data-Analysis/main/dataset/cleaned_bikeshare_hour.csv")
df['dteday'] = pd.to_datetime(df['dteday'])

st.set_page_config(page_title="GoBike Rent: Bike-sharing Dashboard",
                   page_icon="bar_chart:",
                   layout="wide")
...
with st.sidebar:
    ...
    st.image("https://raw.githubusercontent.com/dvpbwxwx/GoBike-Rent-Data-Analysis/main/image/logo.png")
...
st.sidebar.markdown("David Rian Prabowo")
...
# ----- MAINPAGE -----
st.title(":bar_chart: GoBike Rent: Bike-Sharing Dashboard")
st.markdown("##")
...
st.caption('Copyright (c), created by David Rian Prabowo')
